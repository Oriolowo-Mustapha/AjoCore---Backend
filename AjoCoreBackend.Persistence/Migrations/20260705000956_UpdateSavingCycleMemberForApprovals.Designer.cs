...
namespace AjoCoreBackend.Persistence.Migrations
{
    ...
    [Migration("20260705000956_UpdateSavingCycleMemberForApprovals")]
    partial class UpdateSavingCycleMemberForApprovals
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AjoCoreBackend.Domain.Entities.SavingCycle", b =>
                {
                    ...
                    b.Property<int?>("DurationInIntervals")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AjoCoreBackend.Domain.Entities.Trader", b =>
                {
                    ...
                    b.Navigation("SavingCycleMembers");
